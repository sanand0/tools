...
const MODELS = [
  ...
  },
  {
    ...
    url: () => "https://llmfoundry.straive.com/groq/openai/v1/chat/completions",
    extra: "",
  },
  {
    adapter: openai,
...
async function handleImageUpload(file) {
  ...
  try {
    ...
    bootstrapAlert({ title: "Processing error", body: "Error processing image. Please try again.", color: "danger" });
  }
}
