...
assets=(
  ...
  "https://cdn.jsdelivr.net/npm/bootstrap-dark-theme@1" "$vendor/npm/bootstrap-dark-theme@1"
  "https://cdn.jsdelivr.net/npm/lit-html@3/+esm" "$vendor/npm/lit-html@3/+esm"
  "https://cdn.jsdelivr.net/npm/bootstrap-llm-provider@1" "$vendor/npm/bootstrap-llm-provider@1"
  ...
  "https://cdn.jsdelivr.net/npm/lit-html/+esm" "$vendor/npm/lit-html/+esm"
  "https://cdn.jsdelivr.net/npm/lit-html/directives/unsafe-html.js" "$vendor/npm/lit-html/directives/unsafe-html.js"
  "https://cdn.jsdelivr.net/npm/bootstrap-dark-theme@1" "$vendor/npm/bootstrap-dark-theme@1"
  "https://cdn.jsdelivr.net/npm/sortable-tablesort/sortable.min.css" "$vendor/npm/sortable-tablesort/sortable.min.css"
