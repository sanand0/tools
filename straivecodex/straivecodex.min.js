var straivecodex=(()=>{var n=Object.defineProperty;var i=Object.getOwnPropertyDescriptor;var p=Object.getOwnPropertyNames;var d=Object.prototype.hasOwnProperty;var m=(t,r)=>{for(var e in r)n(t,e,{get:r[e],enumerable:!0})},l=(t,r,e,a)=>{if(r&&typeof r=="object"||typeof r=="function")for(let o of p(r))!d.call(t,o)&&o!==e&&n(t,o,{get:()=>r[o],enumerable:!(a=i(r,o))||a.enumerable});return t};var s=t=>l(n({},"__esModule",{value:!0}),t);var f={};m(f,{redesign:()=>b});var c=`
/* ===== GLOBAL COLORS ===== */
...
`;function b(){let t=document.createElement("style");t.textContent=c,document.head.appendChild(t)}return s(f);})();
