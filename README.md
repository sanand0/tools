...
- **[Scroller Bookmarklet](./scroller/)**: Bookmarklet that adds a compact floating autoscroller with live speed, direction, and close controls.
- **[Markdown View Popup](./mdview/)**: Bookmarklet that opens selected Markdown, or the page's full text, in a syntax-highlighted popup.
