...
// function showError(message) { // Replaced by showToast
...
document.getElementById('github-form').addEventListener('submit', async (e) => {
  ...
  const config = {
    ...
    until: document.getElementById('until').value,
        openaiKey: document.getElementById(API_KEY_FIELD_ID).value,
        baseUrl: document.getElementById(BASE_URL_FIELD_ID).value,
